# Data dictionary to the file nba-2018.csv

## Description
We are looking at descriptive data for the players from the 2018 season of the NBA. The data file comes
from the website www.basketball-reference.com.

In particular, our dataset consists of the following columns:
